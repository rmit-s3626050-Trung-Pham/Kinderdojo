...
public class ParentMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LbChildIDExample = new javax.swing.JLabel();
        LbChildName = new javax.swing.JLabel();
        LbChildNameExample = new javax.swing.JLabel();
        LbChildStatus = new javax.swing.JLabel();
        LbChildDOBExample = new javax.swing.JLabel();
        LbChildAvatar = new javax.swing.JLabel();
        jButton2 = new javax.swing.JButton();
        LbBirthday = new javax.swing.JLabel();
        LbChildStatusExample = new javax.swing.JLabel();
        ...
        LbChildIDExample.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LbChildIDExample.setText("C0001");
        PnMyChild.add(LbChildIDExample);
        LbChildIDExample.setBounds(310, 10, 120, 70);
        ...
        LbChildNameExample.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LbChildNameExample.setText("Cersie Lannister");
        PnMyChild.add(LbChildNameExample);
        LbChildNameExample.setBounds(310, 70, 190, 70);
        ...
        LbChildDOBExample.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LbChildDOBExample.setText("12 December 2014");
        PnMyChild.add(LbChildDOBExample);
        LbChildDOBExample.setBounds(310, 130, 190, 70);
        ...
        jButton2.setBounds(60, 410, 65, 27);
        ...
        LbChildStatusExample.setText("Cersie is in a very good mood today! ");
        PnMyChild.add(LbChildStatusExample);
        LbChildStatusExample.setBounds(50, 290, 330, 90);
        ...
        jButton1.setBounds(50, 430, 65, 27);
        ...
        jButton3.setBounds(20, 460, 65, 27);
    ...
    private void BtMyChildActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtMyChildActionPerformed
        // Add My Child Panel
//        child.loadChildDB(dbConn ,childID);
//        
//        LbChildIDExample.setText(childID);
//        LbChildNameExample.setText(child.childName);
//        LbChildDOBExample.setText(child.DOB);
////   THIS HAVN'T SET YET     LbChildStatusExample.setText(ChildStatus.Status);
//       
    ...
    private void BtMyAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtMyAccountActionPerformed
        ...
        parent.loadParentInfo(dbConn ,username);
    ...
    private javax.swing.JLabel LbChildDOBExample;
    private javax.swing.JLabel LbChildID;
    private javax.swing.JLabel LbChildIDExample;
    private javax.swing.JLabel LbChildName;
    private javax.swing.JLabel LbChildNameExample;
    private javax.swing.JLabel LbChildStatus;
    private javax.swing.JLabel LbChildStatusExample;
